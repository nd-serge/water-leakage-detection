...
**_Result_**: Detects consumption variations; sensitive to micro-variations.
...
**_Result_**: Detects significant variations in consumption.
...
**_Result_**: Low sensitivity to small consumption variations.


## Additional Information
	* Read the report: [drive](https://docs.google.com/presentation/d/135wj_trh2rsZ_eNXabBpfaKIyxH9gDa-/edit?usp=sharing&ouid=110200182022425202511&rtpof=true&sd=true)
